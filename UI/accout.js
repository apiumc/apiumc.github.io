(function ($) {
    ...
    WDK.page('accout', '应用账户', function (root) {
        var active = false;
        ...
        root.on('event', function (e, v, em) {
            ...
            switch (v) {
                case 'Role':
                    UMC.UI.Command('Settings', 'Role', { Site: UMC.UI.Config().site || 0 });
                    break;
                case 'User':
                    UMC.UI.Command('Proxy', 'User', { Id: em.attr('data-id'), Site: UMC.UI.Config().site || 0 });
                    break;
            }
