    ...
    WDK.page('organize', '账户组织', function (root) {
        ...
        var Organize = root.find('#Organize').click('a', function () {
            ...
            if (!ul.length) {
                ...
                UMC.UI.Command('Settings', 'Organize', { ParentId: m.attr('data-id') }, function (xhr) {
                    if (xhr.length > 0) {
            ...
            // WDK.UI.Command('Settings', 'Organize', { ParentId: m.attr('data-id'), Type: "User" }, function (x) {
        ...
        root.on('event', function (e, v) {
            ...
            WDK.UI.Command('Settings', 'Organize', { ParentId: v, Type: "User" }, function (x) {
                root.find('table tbody').format(x || [], {}, true)
                    .parent('.el-table').attr('msg', x.length === 0 ? "此组织未有成员" : false).cls('msg', x.length === 0);
            ...
            if (v2.Caption) {
                ...
                if (v2.Top) {
                    UMC.UI.Command('Settings', 'Organize', function (xhr) {
